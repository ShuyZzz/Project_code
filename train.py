...
if __name__ == '__main__':
    ...
    writer = SummaryWriter('fetchreach_logs/' + cfg.run_name)
    ...
    for episode in range(cfg.n_episodes):
        ...
        for t in range(env_params.max_timesteps):
            ...
            action = agent.choose_action_deterministic(state_value)
            next_state, reward, done, info = env.step(action)
        ...
        writer.add_scalar('Success Rate',is_success, episode)
